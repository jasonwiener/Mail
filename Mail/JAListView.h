...
@interface JAListView : NSView {
    ...
    id<JAListViewDataSource> __unsafe_unretained dataSource;
    id<JAListViewDelegate> __unsafe_unretained delegate;
    id<JAListViewDraggingSourceDelegate> __unsafe_unretained draggingSourceDelegate;
    id<JAListViewDraggingDestinationDelegate> __unsafe_unretained draggingDestinationDelegate;
...
@property (weak, nonatomic, readonly) NSScrollView *scrollView;
@property (nonatomic, unsafe_unretained) IBOutlet id<JAListViewDataSource> dataSource;
@property (nonatomic, unsafe_unretained) IBOutlet id<JAListViewDelegate> delegate;
@property (nonatomic, unsafe_unretained) IBOutlet id<JAListViewDraggingSourceDelegate> draggingSourceDelegate;
@property (nonatomic, unsafe_unretained) IBOutlet id<JAListViewDraggingDestinationDelegate> draggingDestinationDelegate;
...
@property (weak, nonatomic, readonly) NSArray *selectedViews;
