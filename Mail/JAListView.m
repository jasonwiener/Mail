...
@property (weak, readonly) NSMutableArray *cachedViews;
@property (nonatomic, readonly) CGFloat *cachedLocations;
@property (nonatomic, strong) NSArray *cachedVisibleViews;
@property (nonatomic, assign) JAListViewItem *viewBeingSelected;
@property (nonatomic, strong) NSArray *viewsCurrentlyBeingDragged;
@property (nonatomic, strong) NSMutableArray *currentlySelectedViews;
@property (nonatomic, strong) NSTrackingArea *currentTrackingArea;
...
@property (nonatomic, strong) NSMutableArray *viewsBeingUsedForInertialScrolling;
...
- (void)drawRect:(NSRect)dirtyRect {
    ...
    [[NSColor colorWithCalibratedRed:232.0f/255.0f green:237.0f/255.0f blue:239.0f/255.0f alpha:1.0f]set];
    NSRectFill(NSMakeRect(self.bounds.size.width-4.0f, 0, 2.0f, self.bounds.size.height));
    [[NSColor colorWithCalibratedRed:241.0f/255.0f green:243.0f/255.0f blue:247.0f/255.0f alpha:1.0f]set];
    NSRectFill(NSMakeRect(self.bounds.size.width-2.0f, 0, 1.0f, self.bounds.size.height));
    [[NSColor colorWithCalibratedRed:247.0f/255.0f green:247.0f/255.0f blue:250.0f/255.0f alpha:1.0f]set];
    NSRectFill(NSMakeRect(self.bounds.size.width-1.0f, 0, 1.0f, self.bounds.size.height));
}
...
- (void)mouseDown:(NSEvent *)event {    
    ...
    self.currentTrackingArea = [[NSTrackingArea alloc] initWithRect:view.frame options:NSTrackingMouseEnteredAndExited | NSTrackingActiveAlways | NSTrackingInVisibleRect | NSTrackingEnabledDuringMouseDrag owner:self userInfo:nil] ;
